              ...
              <Card className='shadow rounded' style={{ width: '18rem', height: '30rem' }}>
                ...
                <Card.Body style={{ overflowY: 'hidden' }} >
                  ...
                  <div className='d-flex justify-content-between'>
                    ...
                    className='btn btn-light'><i className='fa-solid fa-trash text-danger fa-2x'></i></Button>
                    <Button onClick={()=>addTocartFromWishlist(product)} className='btn btn-light'><i class="fa-solid fa-cart-shopping fa-2x"></i></Button>
                  </div>
                </Card.Body>
              </Card>
            </Col>
